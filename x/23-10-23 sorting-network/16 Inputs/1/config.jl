...
function dummy_eco_creator(;
    id::String = "test",
    trial::Int = 1,
    rng::AbstractRNG = StableRNG(12989),
    n_pop::Int = 2,
    ...
    eco_creator = BasicEcosystemCreator(
        ...
        species_creators = Dict(
            species_id1 => PhylogeneticSpeciesCreator(
                id = species_id1,
                n_pop = n_pop,
                geno_creator = SortingNetworkGenotypeCreator(n_codons, n_inputs),
            ...
            species_id2 => PhylogeneticSpeciesCreator(
                id = species_id2,
                n_pop = n_pop,
                geno_creator = SortingNetworkTestCaseGenotypeCreator(n_inputs),
...
eco = evolve!(eco_creator, n_gen=10000)
