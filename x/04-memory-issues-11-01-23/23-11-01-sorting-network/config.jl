...
eco_creator = BasicEcosystemCreator(
    ...
    species_creators = [
        BasicSpeciesCreator(
            ...
            genotype_creator = SortingNetworkGenotypeCreator(min_codons, n_inputs),
            ...
            mutators = [SortingNetworkMutator(min_codons=min_codons,max_codons=max_codons)],
        ),
        BasicSpeciesCreator(
            id = species_id2,
...
eco = #= Profile.Allocs.@profile =# evolve!(eco_creator, n_generations=2000)
# PProf.Allocs.pprof()
